...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("Qual a quantidade de advers�rios?");
			int numeroAdversarios = sc.nextInt();
			String nomeAdversario = "Advers�rio ";
			...
			for (int i = 0; i < numeroAdversarios; i++) {
				...
				//concatena cada "Advers�rio" com o n�mero at� chegar no que foi digitado. 
